...
class ThreeViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.imageView.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -10).isActive = true
        ...
        self.datePicker.topAnchor.constraint(equalTo: view.topAnchor, constant: 90).isActive = true
        self.datePicker.rightAnchor.constraint(equalTo: view.rightAnchor, constant: -10).isActive = true
        ...
        //self.infoLabel.layer.borderWidth = 2
        
        self.infoLabel.minimumScaleFactor = 0.4
        self.infoLabel.adjustsFontSizeToFitWidth = true
        self.view.addSubview(infoLabel)
        self.infoLabel.translatesAutoresizingMaskIntoConstraints = false
        self.infoLabel.topAnchor.constraint(equalTo: datePicker.bottomAnchor, constant: 10).isActive = true
        ...
        self.selectDateLabel.rightAnchor.constraint(equalTo: datePicker.leftAnchor, constant: -10).isActive = true
        ...
        self.urlImageTexrView.topAnchor.constraint(equalTo: infoLabel.bottomAnchor, constant: 20).isActive = true
